      ...
      <div className="mx-auto grid max-w-7xl grid-cols-1 items-center gap-16 px-6 lg:grid-cols-[55%_45%] lg:px-10">
        <div>
          ...
          <TextReveal
            ...
            delay={0.2}
          >
            {`Nexogen Holdings Limited is a technology holding company born in Lagos, Nigeria. We exist to build the software that Africa's next generation deserves — and the world doesn't yet know it needs.
