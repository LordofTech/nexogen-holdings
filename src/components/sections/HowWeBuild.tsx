        ...
        <div className="mt-16 grid gap-6 md:grid-cols-3">
          {cards.map((card, i) => (
            <motion.article
              ...
              className="group rounded-2xl border border-[#1A1A1A] bg-[#0A0A0A] p-8 transition-all duration-400 hover:-translate-y-1 hover:border-[#D4AF37] hover:shadow-[0_20px_60px_rgba(212,175,55,0.15)]"
            ...
            >
              ...
              <p className="font-body mt-3 text-sm leading-relaxed text-[#B8A882]">{card.body}</p>
            </motion.article>
          ))}
        </div>
      </div>
