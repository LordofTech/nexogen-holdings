      ...
      <div className="mx-auto grid max-w-7xl grid-cols-1 items-center gap-12 px-6 lg:grid-cols-2 lg:px-10">
        ...
        >
          ...
          <blockquote className="mt-10 border-l-2 border-[#2D7DD2] pl-6">
            <span className="font-display text-4xl text-[#2D7DD2]">&ldquo;</span>
          ...
          <div className="mt-8 flex flex-wrap gap-3">
            {["Software Engineer", "Fintech Founder"].map((tag) => (
              <span
                key={tag}
                className="font-mono rounded-full border border-[#1A1A1A] px-4 py-2 text-[10px] tracking-[0.15em] text-[#8899AA] uppercase"
              >
                {tag}
              </span>
            ))}
